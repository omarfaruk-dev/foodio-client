              ...
              <>
                <div className="relative">
                  ...
                  >
                    ...
                    <NavLink
                      to="/my-profile"
                      className="flex items-center w-full px-4 py-2 text-primary hover:translate-x-2 duration-500"
                      onClick={() => setUserMenuOpen(false)}
                    >
                    ...
                    <NavLink
                      to="/my-foods"
                      className="flex items-center w-full px-4 py-2 text-primary hover:translate-x-2 duration-500 hover:text-secondary"
                      onClick={() => setUserMenuOpen(false)}
                    >
