    ...
    const features = [
        {
            ...
            description: "Your data and payments are protected with bank-level security. We ensure your privacy and safety at every step.",
            color: "text-success",
        ...
        },
        {
            ...
            title: "Fast Delivery",
            description: "Get your food delivered in 30 minutes or less. We promise lightning-fast delivery to your doorstep.",
            color: "text-info",
            bgColor: "bg-info/5",
        ...
        },
        {
            ...
            description: "Every dish is crafted with passion by our community chefs. Experience authentic flavors made with care.",
            color: "text-error",
            bgColor: "bg-error/5",
        ...
        },
        {
            ...
            description: "Support local businesses and be part of our growing food community. Together we create amazing experiences.",
        ...
        },
        {
            ...
            title: "Top Quality",
            description: "Consistently rated 4.9/5 stars by thousands of customers. Quality you can trust, every single time.",
            color: "text-warning",
        ...
        },
        {
            ...
            description: "We source only the freshest ingredients and support sustainable practices for a better tomorrow.",
            color: "text-success",
            bgColor: "bg-success/5",
            borderColor: "border-success/20"
        }
            ...
            <div className="text-center mb-20">
                <Slide direction="right">
                    <h2 className="text-4xl md:text-5xl font-bold text-primary mb-6">
                        Why Choose <span className="text-secondary border-b-4 border-secondary">Foodio?</span>
                    </h2>
                </Slide>
