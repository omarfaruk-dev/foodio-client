                ...
                <div className="flex flex-col gap-4 p-6 md:p-10 pt-2">
                    ...
                    <div className="flex flex-wrap gap-2 mb-2 justify-center">
                        {Array.isArray(food.food_category)
                            ...
                            : food.food_category && <span className="bg-gradient-to-r from-secondary/80 to-secondary/60 text-accent px-3 py-1 rounded-full text-xs md:text-sm font-semibold shadow-sm border border-secondary/30 uppercase tracking-wide">{food.food_category}</span>
                        }
                    </div>
                    {/* Info row with icons */}
                    ...
                    {/* Details */}
                    <div className="text-base md:text-lg text-accent mb-2 whitespace-pre-line text-left leading-relaxed">
                        {food.details}
                    </div>
                    {/* Ingredients */}
                    <div>
                        <h2 className="font-semibold text-primary mb-1 text-center text-base tracking-wide">Ingredients</h2>
                    ...
                    <div>
                        ...
                        <div className="text-sm md:text-base text-accent whitespace-pre-line text-left leading-relaxed">
